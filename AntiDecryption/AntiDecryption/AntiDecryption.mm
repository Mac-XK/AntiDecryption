#line 1 "/Users/macxk/Desktop/AntiDecryption/AntiDecryption/AntiDecryption.xm"
...
@class NSData; 
static NSData * (*_logos_orig$_ungrouped$NSData$AES128DecryptWithKey$iv$)(_LOGOS_SELF_TYPE_NORMAL NSData* _LOGOS_SELF_CONST, SEL, NSString *, NSString *); static NSData * _logos_method$_ungrouped$NSData$AES128DecryptWithKey$iv$(_LOGOS_SELF_TYPE_NORMAL NSData* _LOGOS_SELF_CONST, SEL, NSString *, NSString *); 

#line 221 "/Users/macxk/Desktop/AntiDecryption/AntiDecryption/AntiDecryption.xm"


static NSData * _logos_method$_ungrouped$NSData$AES128DecryptWithKey$iv$(_LOGOS_SELF_TYPE_NORMAL NSData* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, NSString * key, NSString * iv) {
    ...
    return _logos_orig$_ungrouped$NSData$AES128DecryptWithKey$iv$(self, _cmd, key, iv);
}
...
static __attribute__((constructor)) void _logosLocalCtor_70783221(int __unused argc, char __unused **argv, char __unused **envp) {
    @autoreleasepool {
...
{Class _logos_class$_ungrouped$NSData = objc_getClass("NSData"); { MSHookMessageEx(_logos_class$_ungrouped$NSData, @selector(AES128DecryptWithKey:iv:), (IMP)&_logos_method$_ungrouped$NSData$AES128DecryptWithKey$iv$, (IMP*)&_logos_orig$_ungrouped$NSData$AES128DecryptWithKey$iv$);}} }
#line 377 "/Users/macxk/Desktop/AntiDecryption/AntiDecryption/AntiDecryption.xm"
